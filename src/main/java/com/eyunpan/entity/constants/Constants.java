package com.eyunpan.entity.constants;
...
public class Constants {
     ...
     * 过期时间15分钟
     */
    public static final Integer REDIS_KEY_EXPIRES_FIFTEEN_MIN = REDIS_KEY_EXPIRES_ONE_MIN * 5;


    public static final String REDIS_KEY_DOWNLOAD = "eyunpan:download:";

    public static final String REDIS_KEY_SYS_SETTING = "eyunpan:syssetting:";

    public static final String REDIS_KEY_USER_SPACE_USE = "eyunpan:user:spaceuse:";
